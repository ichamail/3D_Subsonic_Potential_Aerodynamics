        ...
        for it in range(max_iters-1):
            ...
            for i in range(ny):
                ...
                for j in range(nx-2):
                    ...
                    r_j, r_j_plus_1 = r_list[k], r_list[k+1]
                    dr_norm = (r_j_plus_1 - r_j).norm()
                    v_j, v_j_plus_1 = velocity_list[k], velocity_list[k+1]
                    v_m = 0.5 * (v_j + v_j_plus_1) + self.V_fs
                    dr = dr_norm * (v_m/v_m.norm())
...
def induced_velocity_array(r_p_list, panels):
    ...
    for i in prange(num_points):
        ...
        for j in prange(num_panels):
            ...
            Velocity = Vrtx_ring_induced_veloctiy(r_p, panel, core_size=0.3)
